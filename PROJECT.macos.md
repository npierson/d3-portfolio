...
Python 3.11+ is recommended. If you don't have it, install via [Homebrew](https://brew.sh):
...
## Migrating From Another Machine (e.g. fresh clone after working on Linux or another Mac)
...
- **`command not found: python3`** — install Python via Homebrew (see Prerequisites).
